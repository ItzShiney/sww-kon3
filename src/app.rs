        ...
        match event {
            Event::WindowEvent { event, window_id } => {
                ...
                match event {
                    ...
                    WindowEvent::TouchpadMagnify { device_id, delta, phase } => self.on_touchpad_magnify(info, device_id, delta, phase),
                    WindowEvent::SmartMagnify { device_id } => self.on_smart_magnify(info, device_id),
                    WindowEvent::TouchpadRotate { device_id, delta, phase } => self.on_touchpad_rotate(info, device_id, delta, phase),
